...
- [ ] `makeHole` in `junk.test.ts` uses a positional signature (holeNum, par, gross, ctpWinner). Will become crowded when LD/Sandy/Barkie/Polie/Arnie turns add longestDriveWinner, bunkerVisited, treeSolidHit, etc. Consider switching to an object-argument shape when a second junk kind touches the fixture — 2026-04-21 — prompt 052
