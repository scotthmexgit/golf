...
const sampleEvents: ScoringEvent[] = [
  ...
  { kind: 'NassauHoleForfeited', timestamp: 't', hole: 5, actor: 'system', declaringBet: 'b', forfeiter: 'p' },
  { kind: 'NassauWithdrawalSettled', timestamp: 't', hole: 13, actor: 'system', declaringBet: 'b', withdrawer: 'p', points: { p: -1 } },
