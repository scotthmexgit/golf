...
const sampleEvents: ScoringEvent[] = [
  ...
  { kind: 'JunkAwarded', timestamp: 't', hole: 4, actor: 'system', declaringBet: 'b', junk: 'greenie', winners: ['p'], points: { p: 3 } },
  ...
  { kind: 'LongestDriveWinnerSelected', timestamp: 't', hole: 5, actor: 'system', winners: ['p'] },
